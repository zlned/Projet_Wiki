...
<a href="deconnexion.php">Déconnexion</a>
      ...
      <!--  <div>
									...
									<img src="images/bgnouveau.jpg" alt="gallery" width="1500" height="468" class="img-responsive" />                                </div>
...
$req = $bdd->query('SELECT id, titre, auteur, contenue, DATE_FORMAT(date_creation, \'%d/%m/%Y à %Hh%imin%ss\') AS date_creation_fr FROM articles ORDER BY date_creation DESC LIMIT 0, 5');

...
a._zoomButton,"zoom"):L(a,a._zoomButton,"pan"),a._resetButton.getAttribute("state")!==a._cultureInfo.resetText&&L(a,a._resetButton,"reset"));if("undefined"===typeof ha.Chart.creditHref)this.creditHref="portail foot 2015",this.creditText="Portail Foot 2015";else var c=this.updateOption("creditText"),d=this.updateOption("creditHref");if(0===this.renderCount||c||d)this._creditLink.setAttribute("href",this.creditHref),this._creditLink.innerHTML=this.creditText;this.creditHref&&this.creditText?this._creditLink.parentElement||
